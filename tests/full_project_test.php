...
foreach([
    ...
    ['نسخهٔ 5.3', $index, "BORDKHAN_VERSION', '5.3'"],
    ...
    ['v5.3: عکس خارجی بدون پروکسی (media_url)', $index, "preg_match('#^https?://#i', trim(\$path))"],
    ['v5.3: مراحل واقعی از متن مطلب', $index, 'build_steps_from_text(\$cleanDesc)'],
    ['v5.3: محتوای کامل مطلب در قلق', $index, 'محتوای کامل استخراج‌شده از مطلب اصلی'],
    ['v5.3: fallback عکس به URL منبع', $index, 'imagesRemote++'],
    ['v5.3: استخراج متن ۸۰۰۰ کاراکتر', $index, 'extract_article_text($html, 8000)'],
    ['v5.3: لینک مطلب اصلی در پنل', $adminCollect, 'مشاهدهٔ مطلب اصلی'],
    ['v5.3: لینک مطلب اصلی در صفحهٔ قلق (مدیر)', $index, 'مطلب اصلی (ربات)'],
